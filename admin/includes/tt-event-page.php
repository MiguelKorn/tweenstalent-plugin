...
//            $status   = ($guest['boolean']['isInvited'] && !$changedStatus) ? 2 : ($guest['boolean']['isInvited'] ? 0 : 1);
                $status = $guest['boolean']['isAttending'] ? 0 : 1;

                $statuses = array(
                    '<i class="fas fa-circle text-success"></i>', // aanwezig
                    '<i class="fas fa-circle text-info"></i>', // afgemeld
                    '<i class="fas fa-circle text-secondary"></i>', // geen reactie
                    '<i class="fas fa-circle text-white"></i><i class="far fa-circle text-success"></i>' // uitgenodigd
                );

                $statusIcon = $statuses[ $status ];
                $statusName = $status ? 'Afgemeld' : 'Aanwezig';
                ...
                echo "<td>{$date}</td>";
//            echo "<td>{$quest['boolean']['isInvited']}</td>";
                echo "<td>";
