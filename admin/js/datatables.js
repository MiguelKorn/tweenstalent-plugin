            ...
            guestList.DataTable({
                ...
                initComplete: function () {
                    ...
                    jQuery('div.legend').html(
                        ...
                        '<div class="col"><button type="button" class="btn btn-outline-success btn-sm btn-block">Genodigden <span class="badge badge-light">9</span></button></div' +
                        '</div>');
                }
            });
        }
